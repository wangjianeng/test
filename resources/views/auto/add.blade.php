    ...
    <div class="row"><div class="col-md-8">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                @endif
                <form role="form" action="{{ url('auto') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-body">
                            ...
                            <div class="input-group ">
                                ...
                                <select name="user[]" id="user[]" class="mt-multiselect btn btn-default" multiple="multiple" data-label="left" data-width="100%" data-filter="true" data-action-onchange="true">
                                    @foreach ($users as $user_id=>$user_name)
                                        <option value="{{$user_id}}" <?php if(in_array($user_id,old('user')?old('user'):array())) echo 'selected';?>>{{$user_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"  name="date_from" placeholder="From" value="{{old('date_from')}}">
                                ...
                                <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"  name="date_to" placeholder="To" value="{{old('date_to')}}">
                                    <span class="input-group-btn">
                                                                    <button class="btn btn-sm default" type="button">
                                                                        <i class="fa fa-calendar"></i>
                                                                    </button>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control timepicker timepicker-24"  name="time_from" placeholder="From" value="{{old('time_from')}}">
                                        <span class="input-group-btn">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input type="text" class="form-control timepicker timepicker-24"  name="time_to" placeholder="To" value="{{old('time_to')}}">
                                        <span class="input-group-btn">
                                                                <button class="btn default" type="button">
                                                                    <i class="fa fa-clock-o"></i>
                                                                </button>
                            ...
                            <div class="input-group ">
                                <?php
                                     ...
                                     foreach($weeks as $k=>$v){
                                         $checked='';
                                         if(in_array($k,old('weeks')?old('weeks'):array())) $checked = 'checked';
                        ...
                        <!-- 加载编辑器的容器 -->
                            ...
                            <script type="text/javascript">
                                ...
                                ue.ready(function() {
                                    ue.execCommand('inserthtml', '<?php echo old('content');?>');
    ...
    <div class="col-md-4">
        <div class="portlet light bordered" id="blockui_sample_1_portlet_body">
            ...
            <div class="portlet-body">
                ...
                <p></p>
                You can set multiple keywords for Subject, Mail From ; Please use semicolons separated them
                <p></p>
            </div>
        </div>
