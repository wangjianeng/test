...
@section('label', 'Auto Reply List')
@section('content')
    <h1 class="page-title font-red-intense"> Auto Reply List
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Auto Reply List</span>
                    </div>
                </div>
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ url('auto/create')}}"><button id="sample_editable_1_2_new" class="btn sbold blue"> Add New
                        ...
                        @foreach ($rules as $rule)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('auto/'.$rule['id'].'/edit') }}">
                                        <button type="submit" class="btn btn-success btn-xs">Edit</button>
                                    </a>
                                    <form action="{{ url('auto/'.$rule['id']) }}" method="POST" style="display: inline;">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
