                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="item_model" id="item_model" value="{{old('item_model')}}" >
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="star" id="star" value="{{round(old('star'),1)}}" required>
                            </div>
                        </div>
                            ...
                            <div class="input-group ">
                                ...
                                <select class="form-control" name="group_id" id="group_id" required>
                                    ...
                                    @foreach ($groups as $user_id=>$user_name)
                                        <option value="{{$user_id}}" <?php if($user_id==old('group_id')) echo 'selected';?>>{{$user_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="input-group ">
                                ...
                                <select class="form-control" name="review_user_id" id="review_user_id" required>
                                    ...
                                    @foreach ($users as $user_id=>$user_name)
                                        <option value="{{$user_id}}" <?php if($user_id==old('review_user_id')) echo 'selected';?>>{{$user_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
