    ...
    <div class="row"><div class="col-md-8">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                @endif
                <form role="form" action="{{ url('account') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="email" class="form-control" placeholder="Email Address (Important: Use address registered in Seller Central or emails won't send.)" name="account_email" id="account_email" value="{{old('account_email')}}" required />
                            </div>
                        </div>
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <select class="form-control form-filter input-sm" name="type">
									@foreach (getAccountTypes() as $type)
										<option value="{{$type}}" <?php if($type==old('type')) echo 'selected';?>>{{$type}}</option>
									@endforeach
								</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="imap_host" id="imap_host" value="{{old('imap_host')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="imap_port" id="imap_port" value="{{old('imap_port')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="imap_ssl" id="imap_ssl" value="{{old('imap_ssl')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="smtp_host" id="smtp_host" value="{{old('smtp_host')}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="smtp_port" id="smtp_port" value="{{old('smtp_port')}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="smtp_ssl" id="smtp_ssl" value="{{old('smtp_ssl')}}">
                            </div>
                        </div>
