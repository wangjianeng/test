    ...
    <div class="row"><div class="col-md-8">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                @endif
                <form role="form" action="{{ url('rule/'.$rule['id']) }}" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" name="asin" id="asin" value="{{$rule['asin']}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" name="sku" id="sku" value="{{$rule['sku']}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" name="timeout" id="timeout" value="{{$rule['timeout']}}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <select class="form-control" name="reply_status" id="reply_status">
                                    <option value="0" <?php if(0==$rule['reply_status']) echo 'selected';?>>Need reply</option>
                                    <option value="1" <?php if(1==$rule['reply_status']) echo 'selected';?>>Do not need to reply</option>
                                    <option value="99" <?php if(99==$rule['reply_status']) echo 'selected';?>>Trash</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="input-group ">
                                ...
                                <select class="form-control" name="group_id" id="group_id" required>
                                    ...
                                    @foreach ($groups as $group_id=>$group_name)
                                        <option value="{{$group_id}}" <?php if($group_id==$rule['group_id']) echo 'selected';?>>{{$group_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
