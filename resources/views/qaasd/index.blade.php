...
<script>
    var TableDatatablesAjax = function () {
        ...
        var initTable = function () {
            ...
            //grid.setAjaxParam("customActionType", "group_action");
            grid.setAjaxParam("site", $("input[name='product']").val());
            grid.setAjaxParam("asin", $("input[name='brand']").val());
			grid.setAjaxParam("sellersku", $("input[name='title']").val());
            grid.setAjaxParam("create_date_from", $("input[name='create_date_from']").val());
            grid.setAjaxParam("create_date_to", $("input[name='create_date_to']").val());
