...
@section('content')
    ...
    <div class="row"><div class="col-md-8">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                @endif
                <form role="form" action="{{ url('sellertab') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" name="tab" id="tab" value="{{old('tab')}}" required />
                            </div>
                        </div>
    ...
    padding: 6px 12px 6px 40px; width: 100%;" name="color" data-control="hue" value="#ff0000" required>
