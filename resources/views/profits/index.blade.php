...
@section('label', 'Negative Reviews')
@section('content')
    <h1 class="page-title font-red-intense"> Negative Reviews
                    ...
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <button class="btn btn-sm green table-group-action-submit">
                                <i class="fa fa-check"></i> Start matching</button>
                        </div>
                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax_review">
                            <thead>
        ...
        var initTable = function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ url('reviews/get')}}", // ajax source
                    },
                    "order": [
                        [4, "desc"]
