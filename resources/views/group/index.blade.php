...
@section('label', 'Group List')
@section('content')
    <h1 class="page-title font-red-intense"> Group List
            ...
            <div class="portlet light bordered">
                ...
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ url('group/create')}}"><button id="sample_editable_1_2_new" class="btn sbold blue"> Add New
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="manage_account">
                        ...
                        @foreach ($groups as $group)
                            <tr class="odd gradeX">
								...
								<td>
                                    <?php
									unset($user_ids); unset($users_name);
									$user_ids = explode(',',$group['user_ids']);
									foreach($user_ids as $user_id){
										$users_name[] = array_get($users,$user_id);
									}
