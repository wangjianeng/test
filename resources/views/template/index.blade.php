...
@section('label', 'Templates List')
@section('content')
    <h1 class="page-title font-red-intense"> Templates List
        <small></small>
    </h1>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ url('template/create')}}"><button id="sample_editable_1_2_new" class="btn sbold blue"> Add New
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="manage_account">
                        ...
                        @foreach ($templates as $template)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    {{array_get($users,$template['user_id'])}}
                                </td>
                                <td>
                                    ...
                                    <form action="{{ url('template/'.$template['id']) }}" method="POST" style="display: inline;">
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
