                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" placeholder="Buyer Email" name="buyer_email" id="buyer_email" value="{{$review['buyer_email']}}" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" class="form-control" placeholder="Amazon OrderId" name="amazon_order_id" id="amazon_order_id" value="{{$review['amazon_order_id']}}" />
                            </div>
                        </div>
